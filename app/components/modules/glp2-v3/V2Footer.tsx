...
/* Light editorial footer for /glp2-v3 only — ported from /glp2-v2 with the
 * Treatments column swapped so the word "semaglutide" never appears on this
 * page (build-sheet non-negotiable). */

const FOOTER_COLUMNS = [
  {
    heading: "Treatments",
    links: [
      { label: "GLP-1 Tirzepatide", href: "/safety/compounded-tirzepatide" },
    ...
    <footer className="v2-foot">
      <div className="v2-container">
        ...
        <div className="v2-foot__bottom">
          <p className="v2-foot__copy">&copy; 2026 InstaRx. All rights reserved.</p>
          <p className="v2-foot__legal">
            Compounded medications are prescribed by U.S.-licensed physicians and
            dispensed by state-licensed 503A compounding pharmacies.
          </p>
        </div>
      </div>
    </footer>

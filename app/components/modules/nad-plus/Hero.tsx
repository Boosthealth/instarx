...
// component (no undefined lookups) and a typo is a compile error.
const TRUST_ICONS: Record<HeroIconName, LucideIcon> = {
  Stethoscope,
  ClipboardCheck,
  BadgeDollarSign,
};
        ...
        <div className="v2-container v2-hero-grid relative z-10">
          ...
          <div className="v2-hero-copy">
            ...
            <h1 className="v2-display v2-hero-h1 mb-5">
              ...
              <br className="v2-hero-br" /> with NAD+
            </h1>
            ...
            <p className="v2-lede mb-6 max-w-lg">
              ...
              — doctor-prescribed and delivered in 1–2 days.
            </p>
            ...
            <div className="flex flex-wrap items-center gap-x-3 gap-y-1">
              ...
              <span className="text-sm" style={{ color: "var(--v2-ink-soft)" }}>
                250k+ happy customers · No insurance needed
              </span>
            </div>
          </div>
        </div>

...
/* Light, editorial footer for the /partner lander (the rest of the site keeps
 * the shared dark Footer). Layout mirrors the Coivas footer: a brand column
 * with tagline, three link columns separated by hairline rules, a right rail
 * with a "Secure & Encrypted" reassurance + LegitScript seal, and a thin
 * bottom bar. Styling lives in partner.css under `.v2-foot*`. */

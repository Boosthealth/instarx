...
/* Small shared primitives for the /nad-plus lander. The page uses a cream/beige
 * editorial palette, so we don't reuse the shared `home/Button` (it hardcodes a
 * blue hover). Styling comes from nad-plus.css (`.v2-btn*`). */
  ...
  return (
    ...
    >
      ...
      {arrow && (
        ...
        // from bottom-left, with a springy ease. CSS in nad-plus.css.

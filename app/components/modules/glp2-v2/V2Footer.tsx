...
/* Light, editorial footer for the /glp2-v2 lander only (the rest of the site
 * keeps the shared dark Footer). Layout mirrors the Coivas footer: a brand
 * column with tagline, three link columns separated by hairline rules, a right
 * rail with a "Secure & Encrypted" reassurance + LegitScript seal, and a thin
 * bottom bar. Styling lives in glp2-v2.css under `.v2-foot*`. */
      ...
      <div className="v2-container">
        ...
        <div className="v2-foot__bottom">
          <p className="v2-foot__copy">
            &copy; 2026 InstaRx. All rights reserved.
          </p>

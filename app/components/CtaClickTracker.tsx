...
const HOMEPAGE_LANDER_PATHS = new Set(["/start-glp1", "/glp2"]);
 ...
 * project when a visitor clicks an `/intake` CTA on either homepage-lander-
 * split variation (`/start-glp1` blue or `/glp2` pink).
 *

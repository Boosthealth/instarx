...
/* S7 — Testimonials. Stacked, click-to-advance carousel — ported unchanged
 * from /glp2-v2 (same interaction, retinted via glp2-v3.css). Reviews are
 * medication-agnostic service quotes (no injection references, no fabricated
 * spray quotes), per the build sheet. */
...
export function Reviews() {
  ...
  return (
    <section id="reviews" className="v2-section v2-bg-tint">
      <div className="v2-container">
        <Reveal className="mx-auto mb-4 max-w-2xl text-center">
          ...
          <h2 className="v2-h2 mb-4">
            Real people, real <span className="v2-accent">support</span>.
          </h2>
